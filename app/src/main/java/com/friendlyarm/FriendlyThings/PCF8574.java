...
public class PCF8574 {
    ...
    public static int writeCmd4(int devFD, byte command) throws InterruptedException
    {
    ...
    public static int writeCmd8(int devFD, byte command) throws InterruptedException
    {
    ...
    public static int writeData8(int devFD, byte data) throws InterruptedException
    {
